...
class UsuariosController extends ApplicationController {
    ...
    public function agregar(){
        if($this->post('nombre') == ''){
            ...
            if(!$sistema->existslogin(2,$this->post('login'))){
            mysql_query("BEGIN");
    ...
    public function editar($id = ''){
        if($id != ''){
            ...
            $id = intval($id, 10);
            $sistema=new Sistemas();
            if($sistema->usuariodelsistema(2,$id)){
            ...
            $this->error = '';
            $sistema=new Sistemas();
            if($sistema->usuariodelsistema(2,$this->post('id'))){
            $usuario = new Usuarios();
    ...
    public function index($pag = ''){
        ...
        $sql="SELECT count(*) FROM usuarios
            ...
            WHERE sistemasusuarios.sistemas_id='2' ". ($c == "" ? "" : " AND ".$c);
    ...
    public function validarLogin(){
        ...
        if($login != ''){
            ...
            $sql="SELECT count(*) FROM usuarios
            INNER JOIN sistemasusuarios ON usuarios.id=sistemasusuarios.usuarios_id
            WHERE sistemasusuarios.sistemas_id='2' AND login = '" . $login . "'";
