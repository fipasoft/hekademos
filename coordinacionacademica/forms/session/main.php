 ...
 *
 *Modificacion: cuenta con el acronimo del sistema para las sesiones.
 */
class Session {

    /**
     * Crear � especificar el valor para un indice de la sesi�n
     * actual
     *
     * @param string $index
     * @param mixed $value
    ...
    static function set_data($index, $value){
          $_SESSION['session_data'][SYS_ACRONIMO.$index] = $value;
    }
    ...
    static function get_data($index){
          return $_SESSION['session_data'][SYS_ACRONIMO.$index];
    }
    ...
    static function unset_data(){
          ...
          if($lista_args){
                foreach($lista_args as $arg){
                  unset($_SESSION['session_data'][SYS_ACRONIMO.$arg]);
            }
        }
    }

    static function isset_data($index){
        return isset($_SESSION['session_data'][SYS_ACRONIMO.$index]);
    }
}
