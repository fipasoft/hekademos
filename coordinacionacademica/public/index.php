...
//Define el acronimo del sistema para las variables de sesion, esto para que no choquen las variables de un sistema y otro.
$acronimo="coord";

$_SESSION['SYS_ACRONIMO'] = $acronimo;
if($_SESSION['SYS_ACRONIMO']){
    define('SYS_ACRONIMO', $_SESSION['SYS_ACRONIMO']);
} else {
    define('SYS_ACRONIMO', $acronimo);
}
