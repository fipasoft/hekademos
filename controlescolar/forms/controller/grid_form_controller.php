...
/**
 * GridForm: es la clase principal para la generaci�n de formularios
...
abstract class GridForm extends ApplicationControllerBase  {
        ...
        if($this->scaffold){
            ...
            if(count($this->form)){
                ...
                <span style="font-size:16px">Debe especificar las propiedades del formulario a crear en $this->form
                 o coloque var $scaffold = true para generar din�micamente el formulario.
                </span>');
            }
        }
    }
    ...
    /**
     * Realiza la acci�n de inserci�n/actualizaci�n/borrado en GridForm
     *
     */
    function update(){
    ...
    */
    ...
    /**
     * Emula la acci�n de reporte en el controlador llamando a show
     *
     */
    function report(){
        ...
        /**
         * Busca si existe un m�todo o un llamado variable al m�todo
         * before_report, si este m�todo devuelve false termina la ejecuci�n
         * de la acci�n
         */
        ...
        /**
         * Busca si existe un m�todo o un llamado variable al m�todo
         * after_insert, si este m�todo devuelve false termina la ejecuci�n
         * de la acci�n
         */
