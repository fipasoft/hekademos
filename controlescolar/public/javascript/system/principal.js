...
function frm_validar_uno(forma){
forma = $(forma);
for(var i=0; i<forma.elements.length; i++){
if(forma.elements[i].value!='' && forma.elements[i].value!=undefined && forma.elements[i].type!='button' && forma.elements[i].type!='submit' && forma.elements[i].type!='reset'){
return true;
