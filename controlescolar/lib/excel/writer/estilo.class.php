...
class XLSEstilo{
	...
	public function XLSEstilo(){
		...
		$this->catalogo['TH.BGDarkgrayCenter']['setTextWrap'] = '';
		// TH.BGGray
...
//		$this->catalogo['TD.BGLightyellowCenter']['setNumFormat'] = '_-* #,##0.00_-;-* #,##0.00_-;_-* "-"??_-;_-@_-';
		...
		// TH.BGBlue
		$this->catalogo['TH.BGBlue']['setAlign'] = 'center';
		$this->catalogo['TH.BGBlue']['setBold'] = '';
		$this->catalogo['TH.BGBlue']['setBorder'] = '1';
		$this->catalogo['TH.BGBlue']['setFgColor'] = '44';
		$this->catalogo['TH.BGBlue']['setFontFamily'] = 'Arial';
		$this->catalogo['TH.BGBlue']['setSize'] = '10';
		$this->catalogo['TH.BGBlue']['setTextWrap'] = '';
		$this->catalogo['TH.BGBlue']['setVAlign'] = 'vcenter';
		$this->catalogo['TH.BGBlue']['setColor'] = '4';
		$this->catalogo['TH.BGBlue']['setBorderColor'] = '4';
		// TD.BGBlue
		$this->catalogo['TD.BGBlue']['setAlign'] = 'center';
		$this->catalogo['TD.BGBlue']['setBold'] = '';
		$this->catalogo['TD.BGBlue']['setBorder'] = '1';
		$this->catalogo['TD.BGBlue']['setFgColor'] = '1 ';
		$this->catalogo['TD.BGBlue']['setFontFamily'] = 'Arial';
		$this->catalogo['TD.BGBlue']['setSize'] = '10';
		$this->catalogo['TD.BGBlue']['setTextWrap'] = '';
		$this->catalogo['TD.BGBlue']['setVAlign'] = 'vcenter';
		$this->catalogo['TD.BGBlue']['setColor'] = '4';
		$this->catalogo['TD.BGBlue']['setBorderColor'] = '4';
		// H1.BGBlue
		$this->catalogo['H1.Blue']['setAlign'] = 'center';
		$this->catalogo['H1.Blue']['setBold'] = '1';
		$this->catalogo['H1.Blue']['setFontFamily'] = 'Arial';
		$this->catalogo['H1.Blue']['setSize'] = '18';
		$this->catalogo['H1.Blue']['setVAlign'] = 'vcenter';
		$this->catalogo['H1.Blue']['setColor'] = '4';
		// TD.Red
		$this->catalogo['TD.Red']['setAlign'] = 'center';
		$this->catalogo['TD.Red']['setBold'] = '';
		$this->catalogo['TD.Red']['setFgColor'] = '1 ';
		$this->catalogo['TD.Red']['setFontFamily'] = 'Arial';
		$this->catalogo['TD.Red']['setSize'] = '10';
		$this->catalogo['TD.Red']['setTextWrap'] = '';
		$this->catalogo['TD.Red']['setVAlign'] = 'vcenter';
		$this->catalogo['TD.Red']['setColor'] = '10';
		// TD.GrisCentro
		$this->catalogo['TD.GrisCentro']['setAlign'] = 'center';
		$this->catalogo['TD.GrisCentro']['setFgColor'] = '22';
		$this->catalogo['TD.GrisCentro']['setFontFamily'] = 'Arial';
		$this->catalogo['TD.GrisCentro']['setSize'] = '11';
		$this->catalogo['TD.GrisCentro']['setTextWrap'] = '';
		$this->catalogo['TD.GrisCentro']['setVAlign'] = 'vcenter';
		$this->catalogo['TD.GrisCentro']['setBorder'] = '1';
		// TD.GrisCentroBold
		$this->catalogo['TD.GrisCentroBold']['setAlign'] = 'center';
		$this->catalogo['TD.GrisCentroBold']['setBold'] = '1';
		$this->catalogo['TD.GrisCentroBold']['setFgColor'] = '22';
		$this->catalogo['TD.GrisCentroBold']['setFontFamily'] = 'Arial';
		$this->catalogo['TD.GrisCentroBold']['setSize'] = '11';
		$this->catalogo['TD.GrisCentroBold']['setTextWrap'] = '';
		$this->catalogo['TD.GrisCentroBold']['setVAlign'] = 'vcenter';
		$this->catalogo['TD.GrisCentroBold']['setBorder'] = '1';
		// TH.GrayCenter
		$this->catalogo['TH.GrayCenter']['setAlign'] = 'center';
		$this->catalogo['TH.GrayCenter']['setBold'] = '1';
		$this->catalogo['TH.GrayCenter']['setBorder'] = '1';
		$this->catalogo['TH.GrayCenter']['setFontFamily'] = 'Arial';
		$this->catalogo['TH.GrayCenter']['setSize'] = '11';
		$this->catalogo['TH.GrayCenter']['setVAlign'] = 'vcenter';
		$this->catalogo['TH.GrayCenter']['setTextWrap'] = '';
		// TH.BlancoNegro
		$this->catalogo['TH.BlancoNegro']['setAlign'] = 'left';
		$this->catalogo['TH.BlancoNegro']['setBold'] = '1';
		$this->catalogo['TH.BlancoNegro']['setBorder'] = '1';
		$this->catalogo['TH.BlancoNegro']['setColor'] = '1';
		$this->catalogo['TH.BlancoNegro']['setFgColor'] = '8';
		$this->catalogo['TH.BlancoNegro']['setFontFamily'] = 'Arial';
		$this->catalogo['TH.BlancoNegro']['setSize'] = '11';
		$this->catalogo['TH.BlancoNegro']['setVAlign'] = 'vcenter';
