...
class Hoja{
	...
	public function frml_promediar_columna($cc, $rr_ini, $rr_fin){
		return "=AVERAGE(".Spreadsheet_Excel_Writer::rowcolToCell($rr_ini, $cc).":".Spreadsheet_Excel_Writer::rowcolToCell($rr_fin, $cc).")";
	}
