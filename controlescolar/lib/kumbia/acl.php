 ...
 * 
 * La Lista de Control de Acceso o ACLs (del ingl�s, Access Control List) 
 * es un concepto de seguridad inform�tica usado para fomentar la separaci�n 
...
/**
 * Clase para la creaci�n de Resources ACL
 *
 */
class Acl_Resource{
