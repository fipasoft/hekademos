function init(){
    ...
    if(frm){
        ...
        reportes=$('reporte');
            ...
            if(reportes.value=='lista' || reportes.value=='ast' ){
            ...
            }else if(reportes.value=='boletas'){
            ...
            }else if(reportes.value=='resumen'){
    ...
    reportes.onchange=function(){
            if(this.value=='lista' || this.value=='ast' ){
            $('alumnos_').hide();
            $('inscritoslst').hide();
            $('cursos').show();
            }else if(this.value=='boletas'){
            $('inscritoslst').hide();
            $('cursos').hide();
            $('alumnos_').show();
