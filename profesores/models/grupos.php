...
class Grupos extends ActiveRecord{
    ...
    public function asignados(){
        //$asignados = Session :: get_data('prof.grp.asignados');
        $asignados=null;
    ...
    $tutorias=Session :: get_data('prof.usr.tutorias');
        return (array_key_exists($this->id,$tutorias));

    }

    public function estutorporid($id){
    $tutorias=Session :: get_data('prof.usr.tutorias');
        return (array_key_exists($id,$tutorias));
