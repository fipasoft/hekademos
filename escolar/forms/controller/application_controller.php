...
class ApplicationController extends ApplicationControllerBase  {
    ...
    /**
     * Redirecciona la ejecuci�n a otro controlador en un
     * tiempo de ejecuci�n determinado
     *
     ...
     * en sesion y disponibles cada vez que se ejecute una acci�n
     * en el controlador
     *
     * @param boolean $value
     */
